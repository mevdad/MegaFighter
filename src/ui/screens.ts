    ...
    this.root.append(
      ...
      el(
        ...
        section('БАЗОВЫЕ ПРИЁМЫ', [
          ['Присед', '↓ — не только блок снизу, но и уклон: удары рукой и хай-кик проходят над головой'],
          ['Рывок', 'Двойное нажатие вперёд или назад; рывок назад даёт кадры неуязвимости'],
          ['Подсечка', '↓ + хай-кик — сбивает с ног, блокируется только в присяде'],
          ['Апперкот', '↓ + сильная рука — медленный, но подбрасывает и сносит с ног'],
        ...
        section('ПРАВИЛА', [
          ['Добивание', 'После последнего нокаута есть окно: ↓ + сильная рука'],
