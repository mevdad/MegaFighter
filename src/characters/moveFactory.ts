...
const BASE_NORMALS: Record<string, Move> = {
  ...
  hk: {
    ...
    hitstun: 22,
    blockstun: 14,
    // Высокий — противник в приседе просто пропускает его над собой.
    height: 'high',
  ...
  'cr.hp': {
    ...
    blockstun: 15,
    height: 'mid',
    hitbox: { x: 0.72, y: 1.3, w: 0.74, h: 1.0 },
    knockback: { x: 0.12, y: 0.24 },
    launcher: true,
    knockdown: true,
    meterGain: 14,
    clip: CLIP.UPPERCUT,
